...
var reader = (function (){var or__4047__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__4047__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
return (128);
...
var file = cljs.core.get.call(null,map__34721__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__34721__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__34721__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e34720){var _e = e34720;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5718__auto___34723 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5718__auto___34723)){
var seen_errors_34724 = temp__5718__auto___34723;
if(cljs.core.truth_(seen_errors_34724.has(self))){
} else {
seen_errors_34724.add(self);

var temp__5720__auto___34725 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5720__auto___34725)){
var sense_34726 = temp__5720__auto___34725;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_34726)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1557850998926
