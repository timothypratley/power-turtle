...
var o33770 = temp__5718__auto__;
var temp__5718__auto____$1 = (o33770["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o33771 = temp__5718__auto____$1;
return (o33771["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__32880__auto__ = f;
return (o__32880__auto__["toString"]).call(o__32880__auto__);
} else {
return "";
}
}catch (e33772){var _ = e33772;
return "";
}});
...
try{var o__32880__auto___33774 = t;
(o__32880__auto___33774["cljs$lang$ctorPrWriter"]).call(o__32880__auto___33774,t,writer);
}catch (e33773){var __33775 = e33773;
}
...
var char_code = (function (){var o__32880__auto__ = (new String(char$));
return (o__32880__auto__["charCodeAt"]).call(o__32880__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__32880__auto__ = String;
return (o__32880__auto__["fromCharCode"]).call(o__32880__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__33776 = num_code;
switch (G__33776) {
case (1):
return (185);
...
var o__32880__auto__ = String;
return (o__32880__auto__["fromCharCode"]).call(o__32880__auto__,superscript_code);
});
/**
...
}catch (e33778){var _e__32887__auto__ = e33778;
return false;
}})())){
...
var vec__33779 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__33779,(0),null);
...
var or__4047__auto__ = (function (){var temp__5718__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__5718__auto__)){
...
if(cljs.core.truth_(temp__5718__auto__)){
var o33782 = temp__5718__auto__;
var temp__5718__auto____$1 = (o33782["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o33783 = temp__5718__auto____$1;
return (o33783["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4641__auto___33790 = arguments.length;
var i__4642__auto___33791 = (0);
while(true){
if((i__4642__auto___33791 < len__4641__auto___33790)){
args__4647__auto__.push((arguments[i__4642__auto___33791]));

var G__33792 = (i__4642__auto___33791 + (1));
i__4642__auto___33791 = G__33792;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__4648__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__33786){
var vec__33787 = p__33786;
var ns_detector = cljs.core.nth.call(null,vec__33787,(0),null);
var effective_detector = (function (){var or__4047__auto__ = ns_detector;
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
...
var G__33793 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__33794 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__33793;
remaining_tokens = G__33794;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq33784){
var G__33785 = cljs.core.first.call(null,seq33784);
var seq33784__$1 = cljs.core.next.call(null,seq33784);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__33785,seq33784__$1);
});
...
var vec__33798 = cljs.core.split_with.call(null,(function (p1__33797_SHARP_){
return cljs.core.not_EQ_.call(null,p1__33797_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__33798,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__33798,(1),null);
...
var vec__33801 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__33801,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__33801,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__33804 = cljs.core.rest.call(null,remaining_tokens);
var G__33805 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__33804;
name_tokens = G__33805;
continue;
} else {
...
var vec__33808 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__33808,(0),null);
var arity = cljs.core.nth.call(null,vec__33808,(1),null);
var vec__33811 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__33811,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__33811,(1),null);
var vec__33814 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__33814,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__33814,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__33814,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__33814,(3),null);
...
var vec__33820 = result;
var munged_ns = cljs.core.nth.call(null,vec__33820,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__33820,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__33820,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__33820,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__33820,(4),null);
var arity = cljs.core.nth.call(null,vec__33820,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__33824 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__33824,(0),null);
var args = cljs.core.nth.call(null,vec__33824,(1),null);
var vec__33827 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__33827,(0),null);
var name = cljs.core.nth.call(null,vec__33827,(1),null);
...
var G__33830 = (arity + (1));
var G__33831 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__33832){
var vec__33833 = p__33832;
var arity = cljs.core.nth.call(null,vec__33833,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__33833,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__4047__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
...
return cljs.core.get.call(null,arities,p1__33836_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__33837_SHARP_);
...
var args__4647__auto__ = [];
var len__4641__auto___33844 = arguments.length;
var i__4642__auto___33845 = (0);
while(true){
if((i__4642__auto___33845 < len__4641__auto___33844)){
args__4647__auto__.push((arguments[i__4642__auto___33845]));

var G__33846 = (i__4642__auto___33845 + (1));
i__4642__auto___33845 = G__33846;
continue;
} else {
}
break;
...
var argseq__4648__auto__ = ((((1) < args__4647__auto__.length))?(new cljs.core.IndexedSeq(args__4647__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__4648__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__33840){
var vec__33841 = p__33840;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__33841,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq33838){
var G__33839 = cljs.core.first.call(null,seq33838);
var seq33838__$1 = cljs.core.next.call(null,seq33838);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__33839,seq33838__$1);
});
...
var G__33847 = arg;
var G__33847__$1 = (((G__33847 instanceof cljs.core.Keyword))?G__33847.fqn:null);
switch (G__33847__$1) {
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__4047__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var and__4036__auto__ = include_ns_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1((((!(cljs.core.empty_QMARK_.call(null,protocol_name))))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(protocol_name)].join(''):null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1((((!(cljs.core.empty_QMARK_.call(null,protocol_method))))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var or__4047__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__33849__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__33849__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__33849__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__33849__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__33850 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__33850,(0),null);
var fn_name = cljs.core.nth.call(null,vec__33850,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__33850,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__33850,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__33850,(4),null);
var arity = cljs.core.nth.call(null,vec__33850,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__4036__auto__ = protocol_ns;
if(cljs.core.truth_(and__4036__auto__)){
return cljs.core.not.call(null,(function (){var and__4036__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__4047__auto__ = protocol_part;
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
return fn_part;
...
var o__32880__auto__ = f;
return (o__32880__auto__["getBasis"]).call(o__32880__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__4036__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__4036__auto__)){
...
}catch (e33854){var _e__32887__auto__ = e33854;
...
var G__33855 = (obj[cljs.core.first.call(null,path)]);
var G__33856 = cljs.core.rest.call(null,path);
obj = G__33855;
path = G__33856;
continue;
} else {
...
var partition_bits = (function (){var or__4047__auto__ = (obj[partition_key]);
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
return (0);
...
return (function (accum,p__33857){
var vec__33858 = p__33857;
var bit = cljs.core.nth.call(null,vec__33858,(0),null);
var protocol = cljs.core.nth.call(null,vec__33858,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__33861){
var vec__33862 = p__33861;
var ns = cljs.core.nth.call(null,vec__33862,(0),null);
var name = cljs.core.nth.call(null,vec__33862,(1),null);
var selector = cljs.core.nth.call(null,vec__33862,(2),null);
return devtools.munging.make_protocol_descriptor.call(null,ns,name,selector,fast_QMARK_);
});
devtools.munging.protocol_descriptors_comparator = (function devtools$munging$protocol_descriptors_comparator(a__$1,b){
return cljs.core.compare.call(null,new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(a__$1),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(b));
});
...
return cljs.core.compare.call(null,match_to_arity.call(null,a__$1),match_to_arity.call(null,b));
...
return (function (p__33866){
var vec__33867 = p__33866;
var munged_name = cljs.core.nth.call(null,vec__33867,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__33867,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__33867,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__33865_SHARP_){
return (obj[cljs.core.first.call(null,p1__33865_SHARP_)]);
});})(name,sorted_matches,vec__33867,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
return (function (a__$1,b){
return cljs.core.compare.call(null,cljs.core.first.call(null,a__$1),cljs.core.first.call(null,b));
...
//# sourceMappingURL=munging.js.map?rel=1557850997770
