...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__21431 = cljs.core.instance_QMARK_;
var expr__21432 = reactive_val;
if(cljs.core.truth_(pred__21431.call(null,reagent.ratom.RAtom,expr__21432))){
return "ra";
} else {
if(cljs.core.truth_(pred__21431.call(null,reagent.ratom.RCursor,expr__21432))){
return "rc";
} else {
if(cljs.core.truth_(pred__21431.call(null,reagent.ratom.Reaction,expr__21432))){
return "rx";
} else {
if(cljs.core.truth_(pred__21431.call(null,reagent.ratom.Track,expr__21432))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1557850985268
