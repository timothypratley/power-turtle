...
return (new CustomEvent(event_name,(function (){var obj38054 = {"detail":data};
return obj38054;
})()));
} else {
...
var f = (function (){var pred__38061 = cljs.core._EQ_;
var expr__38062 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__38061.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__38062))){
return ((function (pred__38061,expr__38062){
return (function (p1__38055_SHARP_){
return console.warn(p1__38055_SHARP_);
});
;})(pred__38061,expr__38062))
} else {
if(cljs.core.truth_(pred__38061.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__38062))){
return ((function (pred__38061,expr__38062){
return (function (p1__38056_SHARP_){
return console.debug(p1__38056_SHARP_);
});
;})(pred__38061,expr__38062))
} else {
if(cljs.core.truth_(pred__38061.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__38062))){
return ((function (pred__38061,expr__38062){
return (function (p1__38057_SHARP_){
return console.error(p1__38057_SHARP_);
});
;})(pred__38061,expr__38062))
} else {
return ((function (pred__38061,expr__38062){
return (function (p1__38058_SHARP_){
return console.log(p1__38058_SHARP_);
});
;})(pred__38061,expr__38062))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__38065){
...
var opts = map__38066__$1;
var eval_fn = cljs.core.get.call(null,map__38066__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__38068_SHARP_);
});})(new_def))
);
...
figwheel.client.utils.local_persistent_config = (function (){var a__$1 = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
if((((typeof localStorage !== 'undefined')) && ((!((goog.object.get(localStorage,"setItem") == null)))))){
cljs.core.add_watch.call(null,a__$1,new cljs.core.Keyword(null,"sync-local-storage","sync-local-storage",-473590105),((function (a__$1){
return (function (_,___$1,___$2,n){
return cljs.core.mapv.call(null,((function (a__$1){
return (function (p__38069){
var vec__38070 = p__38069;
var ky = cljs.core.nth.call(null,vec__38070,(0),null);
var v = cljs.core.nth.call(null,vec__38070,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1557851000296
